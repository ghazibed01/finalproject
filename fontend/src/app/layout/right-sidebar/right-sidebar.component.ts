...
ngAfterViewInit() {
  ...
  // 🌓 Définir le thème clair par défaut si non défini
  if (!localStorage.getItem('menuOption')) {
    this.lightSidebarBtnClick();
  } else if (localStorage.getItem('menuOption') === 'menu_dark') {
  ...
  if (!localStorage.getItem('theme')) {
    this.lightThemeBtnClick(); // ✅ Appliquer thème clair par défaut
